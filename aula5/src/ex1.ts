//Objetivo: separar o tipo de dado da implementação, para não expor a implementação
...
function filter<A>(lista: Lista<A>, test: (a: A) => boolean): Lista<A>{
