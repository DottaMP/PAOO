console.log(((x: number)=>x)(5)); // arrow function (do ponto do código para baixo) -> (x: number)=>x) define uma função que não tem nome (anonima) e que é aplicado imediatamente.
